...
FIGURE_TYPES = [FigureType.MODELS, FigureType.CROSS_SECTIONS]
...
def main():
    ...
    outer_xs = cosserat.AnalyticalEllipseCrossSection(0.5, 0.5)
    inner_xs = cosserat.AnalyticalEllipseCrossSection(0.2, 0.2)
    # outer_xs = cosserat.AnalyticalRectCrossSection(1, 1)
    # inner_xs = cosserat.AnalyticalRectCrossSection(0.4, 0.4)
    rod = cosserat.PressurizedCosseratRod(NUM_ROD_NODES, ROD_LENGTH, 
                                            cosserat.AnalyticalCavityCrossSection(outer_xs, inner_xs, 0, 0),
                                            1e5, 0.49)
    ...
    for pressure in PRESSURES:
        ...
        deformed_rod.solveOptimizationProblem([], pressure)
