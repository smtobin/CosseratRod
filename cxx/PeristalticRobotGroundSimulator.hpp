#ifndef __PERISTALTIC_ROBOT_GROUND_SIMULATOR_HPP
#define __PERISTALTIC_ROBOT_GROUND_SIMULATOR_HPP
...
template<int N>
class PeristalticRobotGroundSimulator
{

public:

    PeristalticRobotGroundSimulator(PeristalticRobot<N>* robot, const std::vector<std::vector<Real>>& actuator_pressures)
...
#include "PeristalticRobotGroundSimulator.impl.hpp"


#endif // __PERISTALTIC_ROBOT_GROUND_SIMULATOR_HPP