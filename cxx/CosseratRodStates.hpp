#ifndef __COSSERAT_ROD_STATES_HPP
#define __COSSERAT_ROD_STATES_HPP
...
struct CosseratRod_State
{
    ...
    CosseratRod_State operator+(const CosseratRod_State& other)
    {
        CosseratRod_State new_state;
 ...
 */
template <int NumNodes_>
struct CosseratRodWithCrossSectionalDeformation_State
{
    constexpr static int NumNodes = NumNodes_;
    ...
    // constructor initializes the state to be a straight rod with no deformation energy
    CosseratRodWithCrossSectionalDeformation_State()
    {
        state_vec = StateVecType::Zero();
    ...
    // adding two states is just adding the two state vectors
    CosseratRodWithCrossSectionalDeformation_State operator+(const CosseratRodWithCrossSectionalDeformation_State& other)
    {
        CosseratRodWithCrossSectionalDeformation_State new_state;
        new_state.state_vec = state_vec + other.state_vec;
        return new_state;
    }
